...
export default function SearchBar({ 
  ...
  return (
    <div className={`relative w-full pl-15 pr-15 sticky top-5 z-40 pb-4 pt-4 ${className}`}>
        ...
        <div className="relative">
          ...
          {query && (
            <motion.button
              type="button"
              onClick={handleClear}
              className="absolute right-14 top-1/2 transform -translate-y-1/2 text-text-primary/50 hover:text-text-primary/80 transition-colors"
